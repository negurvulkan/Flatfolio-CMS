...
$groups = [
    'Web & Frontend'     => $skills['web']  ?? [],
    'UX, Design & Tools' => $skills['ux']   ?? [],
    'Tech & Struktur'    => $skills['tech'] ?? [],
    'KI & Workflow'      => $skills['ai']   ?? [],
];
?>
<section class="subcard" style="margin-top:18px;" id="skills">
    <div class="subcard-inner">
        ...
        <div class="skills-groups" style="margin-top:12px;">
            ...
            <div>
                <div class="skill-group-title">KI &amp; Workflow</div>
                <div class="skill-chips">
                    <?php foreach ($groups['KI & Workflow'] as $name): ?>
                        <span class="skill-chip"><?= htmlspecialchars($name, ENT_QUOTES) ?></span>
                    <?php endforeach; ?>
                </div>
            </div>
